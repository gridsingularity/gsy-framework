...
class TestValidateDeviceSettings:
    ...
    @pytest.mark.parametrize(
        "valid_arguments",
        [{"max_available_power_kW": 1}, {"energy_rate": 1}, {"energy_rate": 100}],
    )
    ...
    @staticmethod
    @pytest.mark.parametrize(
        "failing_arguments", [{"max_available_power_kW": -1}, {"energy_rate": -1}]
    )
...
class TestHeatPumpValidator:
    ...
    @staticmethod
    @pytest.mark.parametrize("source_type_int, should_fail", [[0, False], [1, False], [2, True]])
