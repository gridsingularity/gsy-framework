...
class ResultsSchemas:
    ...
    results_schema = {
        ...
        "required": ["job_id", "current_market", "random_seed", "status", "progress_info"],
    }
...
class ApiClientConfigSchema:
    ...
    simulation_config_schema = {
        ...
        "registry": {
            ...
            "type": {"type": "string"},
            "uuid": {"type": "string"},
            "attributes": {"anyOf": [{"type": "string"}, {"type": "null"}]},
            "registered": {"anyOf": [{"type": "string"}, {"type": "null"}]},
            "aggregator_name": {"anyOf": [{"type": "string"}, {"type": "null"}]},
