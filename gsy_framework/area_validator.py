...
def validate_area(**kwargs):
    ...
    if key_in_dict_and_not_none_and_negative(kwargs, "export_capacity_kVA"):
        raise GSyAreaException(
            {"misconfiguration": ["export_capacity_kVA must be a " "positive value."]}
        )
